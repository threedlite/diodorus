...
PAIRS_FILE = PROJECT_ROOT / "data-sources" / "parallel" / "grc_eng_pairs.jsonl"
TRAIN_OUT = PROJECT_ROOT / "data-sources" / "parallel" / "train_pairs.jsonl"
EVAL_OUT = PROJECT_ROOT / "data-sources" / "parallel" / "eval_pairs.jsonl"

if not PAIRS_FILE.exists():
    print(f"Error: parallel pairs not found at {PAIRS_FILE}")
    print("Run s02_build_parallel_corpus.py first.")
    raise SystemExit(1)
