#!/usr/bin/env python3
"""
Extract Greek verse from Perseus Moschus — 5 works across separate XML files.

Each work is a short poem (29-166 lines). Lines grouped into ~10-line passages.
Each work becomes a "book" identified by work_id for multi-work TEI generation.

Input:  data-sources/perseus/canonical-greekLit/data/tlg0035/tlg00[1-5]/
Output: build/moschus/greek_sections.json
"""
...
PERSEUS_BASE = PROJECT_ROOT / "data-sources" / "perseus" / "canonical-greekLit" / "data" / "tlg0035"
OUTPUT = PROJECT_ROOT / "build" / "moschus" / "greek_sections.json"
...
WORK_IDS = ["tlg001", "tlg002", "tlg003", "tlg004", "tlg005"]
