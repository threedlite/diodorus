#!/usr/bin/env python3
"""
Extract Greek sections from Perseus Procopius History of the Wars TEI XML.

8 books, 243 chapters, 7240 sections, book.chapter.section hierarchy.

Input:  data-sources/perseus/canonical-greekLit/data/tlg4029/tlg001/
Output: build/procopius_wars/greek_sections.json
"""
...
PERSEUS_DIR = PROJECT_ROOT / "data-sources" / "perseus" / "canonical-greekLit" / "data" / "tlg4029" / "tlg001"
OUTPUT = PROJECT_ROOT / "build" / "procopius_wars" / "greek_sections.json"
