...
OUTPUT = PROJECT_ROOT / "build" / "julian_mother" / "english_sections.json"
...
for div in edition_div:
    ...
    if any("MOTHER OF THE GODS" in t for t in titles):
        in_hymn = True
    if in_hymn and any("INDEX" in t for t in titles):
        break
