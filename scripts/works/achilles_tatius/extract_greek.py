#!/usr/bin/env python3
"""
Extract Greek sections from Perseus Achilles Tatius TEI XML.

Structure: 8 books, 185 chapters, 1035 sections.
CTS ref: book.chapter.section.

Input:  data-sources/perseus/canonical-greekLit/data/tlg0532/tlg001/
Output: build/achilles_tatius/greek_sections.json
"""
...
PERSEUS_DIR = PROJECT_ROOT / "data-sources" / "perseus" / "canonical-greekLit" / "data" / "tlg0532" / "tlg001"
OUTPUT = PROJECT_ROOT / "build" / "achilles_tatius" / "greek_sections.json"
