...
Dionysius of Halicarnassus has a clean 1:1 structure: 12 books, numbered sections
in both Greek and English. Uses the shared segmental_dp_align from align_core.

Inputs:
  output/dionysius/greek_sections.json
  output/dionysius/english_sections.json

Outputs:
  output/dionysius/section_alignments.json
"""
...
OUTPUT = PROJECT_ROOT / "build" / "dionysius" / "section_alignments.json"
