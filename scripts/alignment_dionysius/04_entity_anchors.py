#!/usr/bin/env python3
"""
Validate Dionysius of Halicarnassus alignments with entity anchoring.
...
Input:  output/dionysius/section_alignments.json
Output: output/dionysius/entity_validated_alignments.json
"""
...
GREEK = PROJECT_ROOT / "build" / "dionysius" / "greek_sections.json"
ENGLISH = PROJECT_ROOT / "build" / "dionysius" / "english_sections.json"
ALIGNMENTS = PROJECT_ROOT / "build" / "dionysius" / "section_alignments.json"
OUTPUT = PROJECT_ROOT / "build" / "dionysius" / "entity_validated_alignments.json"
