#!/usr/bin/env python3
"""
Extract Greek sections from Perseus Marcus Aurelius TEI XML.

Input:  data-sources/perseus/canonical-greekLit/data/tlg0562/tlg001/
Output: output/marcus/greek_sections.json
"""
...
PERSEUS_DIR = PROJECT_ROOT / "data-sources" / "perseus" / "canonical-greekLit" / "data" / "tlg0562" / "tlg001"
OUTPUT = PROJECT_ROOT / "build" / "marcus" / "greek_sections.json"
...
edition = xml_path.stem  # e.g. "tlg0562.tlg001.perseus-grc2"
...
for elem in root.iter():
    ...
    # Walk up to find chapter and book numbers
    book_n = None
    chapter_n = None
    ...
    if text and book_n:
        # Build CTS ref: book.chapter.section (or book.section if no chapter)
        if chapter_n:
